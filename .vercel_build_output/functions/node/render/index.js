    ...
    (function(global2, factory) {
      ...
      class DatasetController {
        ...
        _resolveAnimations(index2, transition, active) {
          ...
          if (chart.options.animation !== false) {
            ...
            const scopes = config.getOptionScopes(me.getDataset(), scopeKeys);
            options2 = config.createResolver(scopes, me.getContext(index2, active, transition));
          }
      ...
      class Chart {
        constructor(item, userConfig) {
          ...
          const options2 = config.createResolver(config.chartOptionScopes(), me.getContext());
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-6fb4d924.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-6fb4d924.js", assets + "/_app/chunks/vendor-2f341d21.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-202192a7.js", "css": [], "js": ["pages/__layout.svelte-202192a7.js", "chunks/vendor-2f341d21.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-899a7471.js", "css": [], "js": ["error.svelte-899a7471.js", "chunks/vendor-2f341d21.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-62a81127.js", "css": ["assets/pages/index.svelte-6e07cb9e.css"], "js": ["pages/index.svelte-62a81127.js", "chunks/vendor-2f341d21.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-c08da1a8.js", "css": [], "js": ["pages/about.svelte-c08da1a8.js", "chunks/vendor-2f341d21.js"], "styles": [] } };
...
var SimSettings = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { settings = {
    observer_distance: 1,
    observer_period: 1,
    observee_distance: 2,
  ...
  return `<label for="${"avatar"}">Upload STL File:</label>
<input accept="${".stl"}" id="${"avatar"}" name="${"avatar"}" type="${"file"}">

${``}

<form>Observer Distance
	<input type="${"number"}" min="${"0.1"}" max="${"Number.MAX_SAFE_INTEGER"}"${add_attribute("value", settings.observer_distance, 0)}>
	AU<br>
	Observer Period
	<input type="${"number"}" min="${"0.1"}" max="${"Number.MAX_SAFE_INTEGER"}"${add_attribute("value", settings.observer_period, 0)}>
	years<br>
	Observee Distance
	<input type="${"number"}" min="${"0.1"}" max="${"Number.MAX_SAFE_INTEGER"}"${add_attribute("value", settings.observee_distance, 0)}>
	AU<br>
	Observee Period
	<input type="${"number"}" min="${"0.1"}" max="${"Number.MAX_SAFE_INTEGER"}"${add_attribute("value", settings.observee_period, 0)}>
	years<br>
	Rotational Velocity
	<input type="${"number"}" min="${"0.01"}" max="${"Number.MAX_SAFE_INTEGER"}"${add_attribute("value", settings.vr, 0)}>
	deg/earth day<br>
	Simulation xbound:
	<input type="${"number"}" min="${"200"}" max="${"2000"}"${add_attribute("value", settings.xbound, 0)}>
	pixels<br>
	Simulation ybound
	<input type="${"number"}" min="${"200"}" max="${"2000"}"${add_attribute("value", settings.ybound, 0)}>
	pixels<br></form>`;
});
var css = {
  code: ".row.svelte-15y9it3{display:flex;flex-direction:row;flex-wrap:wrap;width:100%}.column.svelte-15y9it3{display:flex;flex-direction:column;flex-basis:100%;flex:1}",
  map: `{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script>\\n\\timport SimSettings from '../components/SimSettings.svelte';\\n\\timport ThreeSimulation from '../components/ThreeSimulation.svelte';\\n\\timport ThreeVisualizer from '../components/ThreeVisualizer.svelte';\\n\\timport ChartJSPlot from '../components/ChartJSPlot.svelte';\\nimport ChartJsPlot from '../components/ChartJSPlot.svelte';\\n\\n\\tlet settings;\\n\\tlet lightLevel = 420.69;\\n\\tlet lightLevelArray\\n\\n\\t// State tracking\\n\\tlet isRunning = false;\\n\\tfunction toggleRunning() {\\n\\t\\tconsole.log(settings);\\n\\t\\tisRunning = true;\\n\\t}\\n<\/script>\\n\\n<h1>jo</h1>\\n<h2>The Asteroid App of Your Dreams</h2>\\n\\n{#if isRunning}\\n\\t<div class=\\"row\\">\\n\\t\\t<div class=\\"column\\">\\n\\t\\t\\t<ThreeSimulation\\n\\t\\t\\t\\twidth={settings.xbound}\\n\\t\\t\\t\\theight={settings.ybound}\\n\\t\\t\\t\\tobserverDistance={settings.observer_distance}\\n\\t\\t\\t\\tobserverOrbitalPeriod={settings.observer_period}\\n\\t\\t\\t\\tobserveeDistance={settings.observee_distance}\\n\\t\\t\\t\\tobserveeOrbitalPeriod={settings.observee_period}\\n\\t\\t\\t\\tobserveeRotationVelocity={settings.vr}\\n\\t\\t\\t\\tbind:lightLevel\\n\\t\\t\\t\\tbind:lightLevelArray\\n\\t\\t\\t/>\\n\\t\\t</div>\\n\\t\\t<div class=\\"column\\">\\n\\t\\t\\t<ThreeVisualizer\\n\\t\\t\\t\\twidth={settings.xbound}\\n\\t\\t\\t\\theight={settings.ybound}\\n\\t\\t\\t\\tobserverDistance={settings.observer_distance}\\n\\t\\t\\t\\tobserverOrbitalPeriod={settings.observer_period}\\n\\t\\t\\t\\tobserveeDistance={settings.observee_distance}\\n\\t\\t\\t\\tobserveeOrbitalPeriod={settings.observee_period}\\n\\t\\t\\t\\tobserveeRotationVelocity={settings.vr}\\n\\t\\t\\t\\tbind:lightLevel\\n\\t\\t\\t/>\\n\\t\\t</div>\\n\\t</div>\\n\\t<div class=\\"row\\">\\n\\t\\t<div class=\\"column\\">\\n\\t\\t\\t<ChartJsPlot inputData={lightLevelArray} />\\n\\t\\t</div>\\n\\t</div>\\t\\n\\n\\n{:else}\\n\\n\\t<SimSettings bind:settings />\\n\\t<button on:click={toggleRunning}>Run Simulation</button>\\n\\n{/if}\\n\\n<style>\\n\\t.row {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: row;\\n\\t\\tflex-wrap: wrap;\\n\\t\\twidth: 100%;\\n\\t}\\n\\n\\t.column {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tflex-basis: 100%;\\n\\t\\tflex: 1;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAiEC,IAAI,eAAC,CAAC,AACL,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,GAAG,CACnB,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,IAAI,AACZ,CAAC,AAED,OAAO,eAAC,CAAC,AACR,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,UAAU,CAAE,IAAI,CAChB,IAAI,CAAE,CAAC,AACR,CAAC"}`
};
...
${`${validate_component(SimSettings, "SimSettings").$$render($$result, { settings }, {
      settings: ($$value) => {
        settings = $$value;
        $$settled = false;
      }
